...
order = [1, 2, 3]
lam_2 = np.arange(0.01, 0.11, 0.01)
lam_3 = np.arange(20, 420, 20)
#-------------------------------------------------------------------------------
# Analyze auto data
#-------------------------------------------------------------------------------     
...
for i in order:
    ...
    for lam in lambda_range:
        for j in range(2):
            score = hw5.xval_learning_alg(hw5.make_polynomial_feature_fun(i)(auto_data[j]), auto_values, lam, 10)
...
print(score_lst[min_rmse])'''

score_lst = {}

for lam in lam_3:
    score = hw5.xval_learning_alg(hw5.make_polynomial_feature_fun(3)(auto_data[0]), auto_values, lam, 10)
    rmse = (score*sigma)[0][0]
    score_lst[rmse] = [1, 3, lam]
